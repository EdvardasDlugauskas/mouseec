'''
Note: this version of FileBrowser was edited to suit my needs.
github.com/EdvardasDlugauskas
...
from os import walk
from os.path import sep, dirname, expanduser, isdir, join, abspath
...
<FileBrowser>:
    ...
    GridLayout:
        ...
        MDTextField:
			readonly: True
            id: file_text
            text: (root.selection[0] if root.selection else root.path)
            theme_text_color: "Hint"
            hint_text: 'Filename'
            multiline: False
			is_focusable: False
